...
VDFORCEINLINE uint32 ATAudioReaderFLAC::BitReader::GetUnaryValue() {
	...
	// clz compiles to the BSR/LZCNT family on x86_64 and CLZ on ARM64; the
	// original code routed to MSVC's _lzcnt_u32 / _BitScanReverse.
	{
		unsigned long oneBitPos = (unsigned long)(31 - __builtin_clz(bitAccum));
